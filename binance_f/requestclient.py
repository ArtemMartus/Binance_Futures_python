...
class RequestClient(object):
    ...
    def post_order(self, symbol: 'str', side: 'OrderSide', ordertype: 'OrderType',
                   ...
                   newClientOrderId: 'str' = None, stopPrice: 'str' = None,
                   workingType: 'WorkingType' = WorkingType.INVALID, closePosition: 'boolean' = None,
                   positionSide: 'PositionSide' = PositionSide.INVALID, callbackRate: 'str' = None,
                   activationPrice: 'str' = None, newOrderRespType: 'OrderRespType' = OrderRespType.INVALID) -> any:
        """
        New Order (TRADE)
